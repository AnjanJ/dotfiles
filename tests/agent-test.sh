...
# Usage: tests/run agent   (or /opt/homebrew/bin/bash tests/agent-test.sh)
# ============================================
...
section "Test 1: Default and launch commands"
...
section "Test 2: Set, persist, list"
out=$("$A" gemini)
...
section "Test 4: Skill is complete and mapped"
